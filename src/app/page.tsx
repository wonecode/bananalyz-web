      ...
      <main>
        ...
        <section className="pt-36 pb-20 px-6 relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none" aria-hidden>
            <div
              className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[600px] rounded-full blur-[120px]"
              style={{ background: 'rgba(47,107,255,0.1)' }}
            />
            <div
              className="absolute top-1/4 right-0 w-[400px] h-[500px] rounded-full blur-[100px]"
              style={{ background: 'rgba(255,212,59,0.06)' }}
            />
            <div
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <div className="flex justify-center mb-8">
              ...
              >
                <Star size={13} />
                LoL esports predictions for Discord — Season 2025
              </div>
            </div>

            {/* Headline */}
            <div className="text-center mb-6">
              <h1 className="text-5xl sm:text-6xl md:text-7xl font-black tracking-tight leading-[1.0] mb-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-8">
              ...
              <Link
                href="/docs"
                className="flex items-center gap-2 px-7 py-3.5 rounded-xl font-medium text-base transition-all hover:border-white/20"
                style={{
            ...
            <div className="grid lg:grid-cols-3 gap-6 items-start max-w-5xl mx-auto">
              ...
              <div className="lg:col-span-1">
                <div className="relative">
                  <div
                    ...
                    style={{ background: 'rgba(79,150,255,0.08)' }}
                  />
                  <div className="relative">
                    <MatchEmbed />
                  </div>
              ...
              {/* Center: stats + leaderboard peek */}
              <div className="lg:col-span-1 space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <StatCard value="+5" label="Max points" sublabel="per prediction" color="#ffd43b" />
                  <StatCard value="5min" label="Auto-sync" sublabel="match scores" color="#4ade80" />
                  <StatCard value="8" label="Leagues" sublabel="supported" color="#5aa9ff" />
                  <StatCard value="∞" label="Players" sublabel="per server" color="#c084fc" />
                </div>
              </div>
